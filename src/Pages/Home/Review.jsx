                ...
                <div>
                    {
                        reviews.map((review) => <SwiperSlide key={review._id}>
                            ...
                            <div className="flex flex-col items-center mx-24 my-5">
                                ...
                                {/* <Rating className="text-center" style={{ maxWidth: 250 }} value={review.rating} onChange={setRating} /> */}
                                <img src={review.photo} className=' rounded-full w-40 h-40' alt="" />
                                <p className="text-xl text-semibold">{review.name}</p>
                                <p className="text-xl ">{review.position}</p>
